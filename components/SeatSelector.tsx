...
const SeatSelector: React.FC<SeatSelectorProps> = ({ totalSeats, maxSelectable, eventId, selectedSeats, setSelectedSeats }) => {
  ...
  return (
    <div className="p-4 flex flex-col items-center"> {/* Flex container to center content */}
      <h2 className="text-xl font-bold mb-4 text-center">Select up to {maxSelectable} seats</h2> {/* Center text in heading */}
      <div className="grid grid-cols-10 gap-[5px] justify-center"> {/* Reduced gap and justify-center */}
      ...
      <div className="mt-4 text-center"> {/* Center text in selected seats section */}
